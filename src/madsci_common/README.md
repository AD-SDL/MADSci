...
MADSci provides standalone backup tools for FerretDB databases that can be used independently or integrated with migration workflows:
...
```bash
# Create FerretDB backup (auto-detects database type)
...
- Unified CLI for both PostgreSQL and FerretDB
