...
class Experiment(MadsciBaseModel):
    ...
    def from_experiment_design(
        ...
        return cls(
            ...
            ownership_info=OwnershipInfo(**(experiment_design.ownership_info.model_dump(exclude_none=True) if experiment_design.ownership_info else get_current_ownership_info().model_dump(exclude_none=True))),
        )
