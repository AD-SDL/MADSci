...
def test_basic_functionality():
    ...
    config = TransferManagerConfig(
        robot_definitions_path=Path("/Users/dozgulbas/workspace/MADSci/src/madsci_transfer_manager/madsci/transfer_manager/test_robot_definitions.yaml"),
        location_constraints_path=Path("/Users/dozgulbas/workspace/MADSci/src/madsci_transfer_manager/madsci/transfer_manager/test_location_constraints.yaml")
    )
...
def test_transfer_options():
    ...
    for option in options:
        ...
        print(f"    Path: {' → '.join([hop['source'] for hop in option['path']] + [option['path'][-1]['target']])}")
...
def main():
    ...
    print("Make sure /Users/dozgulbas/workspace/MADSci/src/madsci_transfer_manager/madsci/transfer_manager/test_robot_definitions.yaml and /Users/dozgulbas/workspace/MADSci/src/madsci_transfer_manager/madsci/transfer_manager/test_location_constraints.yaml are in the current directory")
