...
Defines how SilaNodeClient executes SiLA2 commands (observable and unobservable), resolves action names to SiLA features/commands, maps responses (including bytes) to ActionResult, and classifies errors during command dispatch.
## Requirements
