...
MADSci enables modular integration of lab equipment, devices, robots, sensors, and any other components necessary for the operation of an automated or self driving lab via the MADSci Nodes API (see Fig. 1).
