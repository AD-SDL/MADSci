...
| `EVENTS_COLLECTION_NAME`                                 | `string`                          | `"madsci_events"`             | The name of the MongoDB collection where events are stored. | `"madsci_events"`             |
...
| Name                                                               | Type               | Default                       | Description                                            | Example                       |
|--------------------------------------------------------------------|--------------------|-------------------------------|--------------------------------------------------------|-------------------------------|
| `EXPERIMENT_SERVER_URL` \| `EXPERIMENT_SERVER_URL`                 | `string`           | `"http://localhost:8002"`     | The URL of the experiment manager server.              | `"http://localhost:8002"`     |
