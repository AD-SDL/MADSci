...
| `WORKCELL_RECONNECT_ATTEMPT_INTERVAL`                                          | `number`                         | `1200.0`                                                 | The interval at which the workcell resets disconnected nodes, in seconds. Must be <= scheduler_update_interval                                                                           | `1200.0`                                                 |
