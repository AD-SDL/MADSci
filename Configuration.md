...
| `DATA_ENABLE_REGISTRY_RESOLUTION`           | `boolean`                           | `false`                       | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                         | `false`                       |
| `DATA_MANAGER_NAME`                         | `string` \| `NoneType`              | `null`                        | Name for registry lookup. Overrides the name from the definition file when set.                                            | `null`                        |
| `DATA_MANAGER_DESCRIPTION`                  | `string` \| `NoneType`              | `null`                        | Override the description from the definition file.                                                                         | `null`                        |
...
| `EVENT_ENABLE_REGISTRY_RESOLUTION`           | `boolean`                           | `false`                       | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                         | `false`                       |
| `EVENT_MANAGER_NAME`                         | `string` \| `NoneType`              | `null`                        | Name for registry lookup. Overrides the name from the definition file when set.                                            | `null`                        |
| `EVENT_MANAGER_DESCRIPTION`                  | `string` \| `NoneType`              | `null`                        | Override the description from the definition file.                                                                         | `null`                        |
...
| `WORKCELL_ENABLE_REGISTRY_RESOLUTION`                                          | `boolean`                           | `false`                                                  | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                                                                                       | `false`                                                  |
| `WORKCELL_MANAGER_NAME`                                                        | `string` \| `NoneType`              | `null`                                                   | Name for registry lookup. Overrides the name from the definition file when set.                                                                                                          | `null`                                                   |
| `WORKCELL_MANAGER_DESCRIPTION`                                                 | `string` \| `NoneType`              | `null`                                                   | Override the description from the definition file.                                                                                                                                       | `null`                                                   |
...
| `WORKCELL_NODES`                                                               | `object` \| `NoneType`              | `null`                                                   | Node URLs for the workcell, as a JSON dict. When set, overrides the nodes from the definition file.                                                                                      | `null`                                                   |
...
| `EXPERIMENT_ENABLE_REGISTRY_RESOLUTION`           | `boolean`                           | `false`                       | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                         | `false`                       |
| `EXPERIMENT_MANAGER_NAME`                         | `string` \| `NoneType`              | `null`                        | Name for registry lookup. Overrides the name from the definition file when set.                                            | `null`                        |
| `EXPERIMENT_MANAGER_DESCRIPTION`                  | `string` \| `NoneType`              | `null`                        | Override the description from the definition file.                                                                         | `null`                        |
...
| `RESOURCE_ENABLE_REGISTRY_RESOLUTION`  | `boolean`                           | `false`                                                 | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                                    | `false`                                                 |
| `RESOURCE_MANAGER_NAME`                | `string` \| `NoneType`              | `null`                                                  | Name for registry lookup. Overrides the name from the definition file when set.                                                       | `null`                                                  |
| `RESOURCE_MANAGER_DESCRIPTION`         | `string` \| `NoneType`              | `null`                                                  | Override the description from the definition file.                                                                                    | `null`                                                  |
...
| `RESOURCE_DEFAULT_TEMPLATES_FILE`      | `string` \| `Path` \| `NoneType`    | `null`                                                  | Path to a YAML file containing default resource template definitions. When set, overrides default_templates from the definition file. | `null`                                                  |
...
| `LAB_ENABLE_REGISTRY_RESOLUTION`  | `boolean`                           | `false`                    | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                         | `false`                    |
| `LAB_MANAGER_NAME`                | `string` \| `NoneType`              | `null`                     | Name for registry lookup. Overrides the name from the definition file when set.                                            | `null`                     |
| `LAB_MANAGER_DESCRIPTION`         | `string` \| `NoneType`              | `null`                     | Override the description from the definition file.                                                                         | `null`                     |
...
| `LOCATION_ENABLE_REGISTRY_RESOLUTION`  | `boolean`                           | `false`                    | When true, resolve manager_id from the ID Registry at startup instead of from the definition YAML.                         | `false`                    |
| `LOCATION_MANAGER_NAME`                | `string` \| `NoneType`              | `null`                     | Name for registry lookup. Overrides the name from the definition file when set.                                            | `null`                     |
| `LOCATION_MANAGER_DESCRIPTION`         | `string` \| `NoneType`              | `null`                     | Override the description from the definition file.                                                                         | `null`                     |
...
| `LOCATION_LOCATIONS_FILE`              | `string` \| `Path` \| `NoneType`    | `null`                     | Path to a YAML file containing location definitions. When set, overrides locations from the definition file.               | `null`                     |
| `LOCATION_TRANSFER_CAPABILITIES_FILE`  | `string` \| `Path` \| `NoneType`    | `null`                     | Path to a YAML file containing transfer capabilities. When set, overrides transfer_capabilities from the definition file.  | `null`                     |
