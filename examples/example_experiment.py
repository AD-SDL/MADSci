"""Example experiment script using MADSci ExperimentScript.

This demonstrates a simple automated experiment that:
1. Sets up resources (plate) in the correct locations
2. Runs a workflow loop (liquid handler → plate reader) until a
   measurement target is reached
3. Tracks the experiment lifecycle automatically
...
if __name__ == "__main__":
    ExampleExperiment.main(lab_server_url="http://localhost:8000")
