...
# lock_acquired = client.acquire_lock(stack, lock_duration=60.0)
...
# lock_released = client.release_lock(stack)
# print(f"Lock released: {lock_released}")
...
# print("Testing resource refresh")
# try:
#     refreshed_stack = stack.refresh()
...
#     pool = pool.increase_quantity(25.0)
#     print(f"Increase quantity successful - new quantity: {pool.quantity}")

#     pool = pool.decrease_quantity(10.0)
