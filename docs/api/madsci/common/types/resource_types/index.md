...
:   Data Model for a Grid. A grid is a container that can hold other resources in two dimensions and supports random access. For example, a 96-well microplate. Grids are indexed by integers or letters.
    ...
    * madsci.common.types.resource_types.VoxelGrid
    ...
    `get_child(self, key: str | tuple[int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)], int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)]] | int) ‑> madsci.common.types.resource_types.Resource | madsci.common.types.resource_types.Asset | madsci.common.types.resource_types.Consumable | madsci.common.types.resource_types.DiscreteConsumable | madsci.common.types.resource_types.ContinuousConsumable | madsci.common.types.resource_types.Container | madsci.common.types.resource_types.Collection | madsci.common.types.resource_types.Row | madsci.common.types.resource_types.Grid | madsci.common.types.resource_types.VoxelGrid | madsci.common.types.resource_types.Stack | madsci.common.types.resource_types.Queue | madsci.common.types.resource_types.Pool | madsci.common.types.resource_types.Slot | None`
    :   Get a child from the Grid.

    `initialize_grid(self) ‑> None`
    :   Creates a grid of the correct dimensions

    `set_child(self, key: str | tuple[int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)], int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)]] | int, child: ResourceDataModels) ‑> None`
    :   Get a child from the Grid.
...
:   Data Model for a Row. A row is a container that can hold other resources in a single dimension and supports random access. For example, a row of tubes in a rack or a single-row microplate. Rows are indexed by integers or letters.
    ...
    * madsci.common.types.resource_types.Grid
    ...
    `check_key_bounds(self, key: str | int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)]) ‑> bool`
    ...
    `get_child(self, key: int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)]) ‑> madsci.common.types.resource_types.Resource | madsci.common.types.resource_types.Asset | madsci.common.types.resource_types.Consumable | madsci.common.types.resource_types.DiscreteConsumable | madsci.common.types.resource_types.ContinuousConsumable | madsci.common.types.resource_types.Container | madsci.common.types.resource_types.Collection | madsci.common.types.resource_types.Row | madsci.common.types.resource_types.Grid | madsci.common.types.resource_types.VoxelGrid | madsci.common.types.resource_types.Stack | madsci.common.types.resource_types.Queue | madsci.common.types.resource_types.Pool | madsci.common.types.resource_types.Slot | None`
    :   Get a child from the Row.

    `numericize_index(self, key: str | int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)]) ‑> int | str`
    :   Convert a key to a numeric value.

    `populate_children(self, children: dict[int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)], 'ResourceDataModels']) ‑> None`
    :   Populate the children of the grid.

    `set_child(self, key: int | typing.Annotated[str, AfterValidator(func=<function single_letter_or_digit_validator at 0x10cf69480>)], value: ResourceDataModels) ‑> None`
