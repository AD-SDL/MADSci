...
`HTTPInterfaceSettings(**values: Any)`
...
`SerialInterfaceSettings(**values: Any)`
...
`SocketInterfaceSettings(**values: Any)`
...
`USBInterfaceSettings(**values: Any)`
