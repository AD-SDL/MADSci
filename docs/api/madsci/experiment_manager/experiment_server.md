...
`ExperimentManager(settings: madsci.common.types.experiment_types.ExperimentManagerSettings | None = None, db_client: pymongo.synchronous.mongo_client.MongoClient | None = None, db_connection: pymongo.synchronous.database.Database | None = None, document_handler: madsci.common.db_handlers.document_storage_handler.DocumentStorageHandler | None = None, **kwargs: Any)`
