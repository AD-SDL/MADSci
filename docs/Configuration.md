...
| `DATA_FILE_STORAGE_PATH`                    | `string` \| `Path`                  | `"/Users/luckierdodge/AD-SDL/MADSci/.madsci/datapoints"` | The path where files are stored on the server.                                                                                                      | `"/Users/luckierdodge/AD-SDL/MADSci/.madsci/datapoints"` |
...
| `EVENT_BACKUP_DIR`                           | `string` \| `Path`                  | `"<project_dir>/.madsci/backups/events"` | Directory for event backups.                                                                                                                        | `"<project_dir>/.madsci/backups/events"` |
...
| `WORKCELLS_DIRECTORY` \| `WORKCELLS_DIRECTORY`        | `string` \| `Path` \| `NoneType`    | `"<project_dir>/.madsci/workcells"`                      | Directory used to store workcell-related files in. Defaults to .madsci/workcells. Workcell-related files will be stored in a sub-folder with the workcell name.                          | `"<project_dir>/.madsci/workcells"`                      |
...
| `EVENT_CLIENT_LOG_DIR`                        | `string` \| `Path`                  | `"<project_dir>/.madsci/logs"` | The directory to store logs in.                                                                    | `"<project_dir>/.madsci/logs"` |
...
| Name                          | Type      | Default                                                 | Description                                   | Example                                                 |
|-------------------------------|-----------|---------------------------------------------------------|-----------------------------------------------|---------------------------------------------------------|
| `POSTGRES_BACKUP_DIR`         | `Path`    | `"<project_dir>/.madsci/backups"`                       | Directory for storing backups                 | `"<project_dir>/.madsci/backups"`                       |
...
| Name                             | Type                   | Default                           | Description                                  | Example                           |
|----------------------------------|------------------------|-----------------------------------|----------------------------------------------|-----------------------------------|
| `MONGODB_BACKUP_DIR`             | `Path`                 | `"<project_dir>/.madsci/backups"` | Directory for storing backups                | `"<project_dir>/.madsci/backups"` |
...
| `MONGODB_MIGRATION_BACKUP_DIR`                                               | `string` \| `Path`               | `"<project_dir>/.madsci/backups/mongodb"` | Directory where database backups will be stored.                                                  | `"<project_dir>/.madsci/backups/mongodb"` |
...
| `RESOURCES_MIGRATION_BACKUP_DIR`         | `string` \| `Path`               | `"<project_dir>/.madsci/backups/postgresql"` | Directory where database backups will be stored.                                                                                                    | `"<project_dir>/.madsci/backups/postgresql"` |
