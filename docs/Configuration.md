...
| `SEED_LOCATIONS_FILE` \| `LOCATIONS_FILE_PATH` | `string` \| `NoneType`                       | `"locations.yaml"`             | Path to a YAML file containing location definitions. Loaded once to seed an empty database on first startup; ignored if locations already exist.        | `"locations.yaml"`             |
