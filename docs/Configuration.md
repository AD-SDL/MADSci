...
| `LOCATION_REDIS_HOST`                          | `string`                                     | `"localhost"`                  | The host of the Redis server for transient state (locks, change counters).                                                                              | `"localhost"`                  |
| `LOCATION_REDIS_PORT`                          | `integer`                                    | `6379`                         | The port of the Redis server for transient state.                                                                                                       | `6379`                         |
